				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="卖家账号" prop="maijiazhanghao">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.maijiazhanghao?true:false"
								v-model="form.maijiazhanghao" 
								placeholder="请选择卖家账号"
								@change="maijiazhanghaoChange">
								<el-option v-for="(item,index) in maijiazhanghaoLists" :label="item" :value="item">
								</el-option>
							</el-select>
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="留言时间" prop="liuyanshijian">
							<el-date-picker
								class="list_date"
								v-model="form.liuyanshijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.liuyanshijian?true:false"
								placeholder="请选择留言时间" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.neirong = res.data.data.neirong?(res.data.data.neirong.replace(reg,'../../../cl82387225/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.liuyanshijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='liuyanshijian'){
					form.value.liuyanshijian = row[x];
					disabledForm.value.liuyanshijian = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
	...
	const maijiazhanghaoChange=()=>{
		context?.$http({
			url: `follow/maijia/maijiazhanghao?columnValue=` + form.value.maijiazhanghao,
			method: 'get'
		}).then(res=>{
			if(res.data.data.maijiaxingming){
				form.value.maijiaxingming = res.data.data.maijiaxingming
			}
		})
	}
	//富文本
